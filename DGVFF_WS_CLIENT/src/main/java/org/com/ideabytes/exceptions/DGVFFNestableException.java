 ...
 * 
 * <DGVFFNestableException.java>, V.0.0.1
 *
 ...
 * 
 */
public class DGVFFNestableException extends NestableRuntimeException {
	...
	public DGVFFNestableException(final long code, final String message) {
		super(message);
		this.code = code;
	}
