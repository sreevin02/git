...
/**
 * This Servlet is used to serve the Static content from Tomcat. 
 * Currently its used to Serve the Swagger API Explorer but can be used
 * for other static content as well if needed in future.
 */
package org.com.ideabytes.servlet;
...
public class FileServlet extends HttpServlet {
	...
	/**
	 * Process doOptions request. Returns the CORS support headers
	 * 
	...
	protected void doOptions(HttpServletRequest request,
		...
		response.setHeader("Access-Control-Allow-Methods",
				"POST,OPTIONS,PUT,PATCH,GET,HEAD");
